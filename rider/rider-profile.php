...
if (strlen($_SESSION['pgasoid']==0)) {
  ...
  $mobno=$_POST['contactnumber'];
     ...
     $query=mysqli_query($con, "update tblrider set FullName ='$fullname', MobileNumber='$mobno' where ID='$donorid'");
    if ($query) {
...
<section id="main-content">
   ...
   <?php
 $donorid=$_SESSION['pgasoid'];
$ret=mysqli_query($con,"select * from tblrider where ID='$donorid'");
$cnt=1;
