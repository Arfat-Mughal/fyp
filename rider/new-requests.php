...
tblfoodrequests
 join tblfood  on tblfood.ID=tblfoodrequests.foodId where (tblfoodrequests.status Like 'Food Take Away/ Request Completed') and (tblfoodrequests.riderRemarks is null || tblfoodrequests.riderRemarks='')");
$cnt=1;
