...
if (strlen($_SESSION['pgasoid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $status = $_POST['status'];
        $query = mysqli_query($con, "update tblfood set riderRemarks='$donormsg',distribution_center='$status' where foodid='$frid'");
        if ($query) {
                ...
                <div class="table-agile-info">
                    <div class="panel panel-default">
                        ...
                        <div>
                            ...
                            $ret = mysqli_query($con, "select * from tblfood join tbldonor on tblfood.DonorID=tbldonor.ID where tblfood.foodId='$fid'");
                            while ($row = mysqli_fetch_array($ret)) {
                                ...
                                <?php if ($row['riderRemarks'] == "") { ?>
                                    <form method="post" name="submit">
                                        <tr>
                                            <th>Delivered to Distribution center :</th>
                                            <td>
                                        ...
                                        <tr>
                                            <th>Rider Remark:</th>
                                            <td><textarea class="form-control" required name="donaremark"></textarea>
                                            </td>
                                        </tr>
                                        <tr align="center">
                                            <td colspan="2">
