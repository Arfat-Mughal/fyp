...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select Email from tblrider where Email='$email'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email or Contact Number already associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into tblrider(FullName, MobileNumber, Email,  Password) value('$fname', '$mobno', '$email', '$password' )");
    if ($query) {
...
<!DOCTYPE html>
<head>
<title>FWMS | Rider Registration </title>
