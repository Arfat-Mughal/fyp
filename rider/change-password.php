...
$query=mysqli_query($con,"select ID from tblrider where ID='$donorid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblrider set Password='$newpassword' where ID='$donorid'");
