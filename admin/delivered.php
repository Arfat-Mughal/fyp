    ...
    <section id="container">
        ...
        "sorting": {
          "enabled": true
                                ...
                                $ret=mysqli_query($con,"SELECT * FROM tblfood join tbldonor on tblfood.DonorID=tbldonor.ID where tblfood.delivered_to is not null and tblfood.delivered_address is not null)");
                                $cnt=1;
